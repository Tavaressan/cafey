"""Arranjo interno (variante 3D): Peca 1 + Peca 2 + divisoria + volumes de referencia.
...
tensao). Cada componente e' uma CAIXA ENVOLVENTE estimada, lida de
mechanical/params/componentes.csv.
...
def main():
    ...
    print("step  :", _env.ARRANJO_STEP, "(divisoria + volumes, sem as pecas impressas)")
